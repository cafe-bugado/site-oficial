    ...
    <section id="home" className="relative min-h-screen flex items-center pt-20 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="absolute rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-600/20 animate-float"
            style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
            <div className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/10 to-purple-600/10 border border-cyan-500/20 dark:border-purple-600/20 text-cyan-600 dark:text-cyan-400 font-medium text-sm mb-2 animate-fadeIn">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white animate-slideUp">
              Onde
              <span className="relative inline-block px-2">
                <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-purple-600">
                ...
                <span className="absolute inset-0 h-full w-full bg-cyan-400/10 dark:bg-cyan-600/10 rounded-lg transform -skew-x-2"></span>
              </span>
              se encontram
            </h1>

            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0 animate-slideUp" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4 animate-slideUp" style={{ animationDelay: '0.4s' }}>
              <a
                href="#community"
                className="px-6 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/20 transition-all transform hover:-translate-y-1 w-full sm:w-auto text-center"
              >
                Entrar no Discord
              </a>
              <a
                href="#events"
                className="px-6 py-3 rounded-lg border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-all w-full sm:w-auto text-center group flex items-center justify-center"
              >
          ...
          <div className="w-full lg:w-1/2 mt-16 lg:mt-0 flex justify-center lg:justify-end animate-fadeIn" style={{ animationDelay: '0.6s' }}>
            <div className="relative w-full max-w-lg">
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 rounded-full blur-3xl"></div>
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 rounded-full blur-3xl"></div>
            </div>
          </div>
        </div>
      </div>
